...
const OrderDetails = () => {
    ...
    return (
      <div className={styles.wrapper}>
        <p className={clsx(styles.id, 'text text_type_digits-default pb-10')}># {modalSelected.order._id}</p>
        <p className={clsx(styles.name, 'text text_type_main-medium pb-3')}>Название бургера (пока не передается)</p>
